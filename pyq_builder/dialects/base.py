...
from pyq_builder.datastructures.container import Container
...
class Resolver(Protocol):
    ...
    def filter(self, resolved_fields: str) -> "DialectFilter":
        ...
...
class DriverTypes(Protocol):
    ...
    def get_connection_uri(self, is_async: bool, cfg: "QBuilderConfig") -> str:
        ...
        return f"{driver_prefix}://{cfg.user}:{cfg.passwd}@{cfg.host}:{cfg.get_port()}/{cfg.database}"
